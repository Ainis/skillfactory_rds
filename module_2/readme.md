...
2. Выделение двух типов критериев - числовых и номинативных. Разбиение датасета на два - с нулевым результатом, и со всеми остальными результатами.
...
7. Возможно стоит строить дополнительную модель, которая будет отвечать на вопрос "Сдаст ли студент экзамен?", и при положительном ответе - запускать следующую модель, отвечающую на вопрос, какой будет результат экзамена.
